/*
 * RechnungAdresseConverterImplTest.java
 *
...
public class RechnungAdresseConverterTest {
    ...
    @InjectMocks
    private RechnungAdresseConverter classUnderTest;
    ...
    public void testConvert_HHGWMitFirmenAdressdatenGegeben_SollteAdresseMitGegebenenFirmenadressdatenLiefern()
        ...
        hhgw.setBillCity(stadt);
        hhgw.setBillCountry(land);
        hhgw.setBillStreet(strasse);
        hhgw.setBillStreetnumber(hausnummer);
        hhgw.setBillZipcode(postleitzahl);
