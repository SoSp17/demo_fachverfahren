/*
 * PostfachConverterImplTest.java
 *
...
public class PostfachConverterTest {
    @Rule
    public MockitoRule mockito = MockitoJUnit.rule().strictness(Strictness.STRICT_STUBS);
    @InjectMocks
    private RechnungsPostfachConverter classUnderTest;
    ...
    public void testConvert_PostfachdatenGegeben_SolltePostfachdatenExtrahierenUndSetzen()
        ...
        final HHGW hhgw = new HHGW().setBillBoxZipcode(postleitzahl).setBillBox(nummer);
